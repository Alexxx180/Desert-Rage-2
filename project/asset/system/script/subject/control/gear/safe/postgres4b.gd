...
func set_status(_value) -> void: pass
...
## Fires when the connection to the backend closes. If connection closed correctly "was_clean_close" is true otherwise false.
