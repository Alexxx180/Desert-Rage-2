...
enum { HINTS, BOOKS, PAGES, ENEMY }

var manual: PackedStringArray:
	get: return Works.loads("manual", HUD.REF, new_manual)

func new_manual() -> PackedStringArray: return hints.split("-")
...
@export var hints: String = "MM-MJ-MB-ML-CN-AA-AE-AF-AT-SR-AW-AH-AM-RG-RM-BY-BK-RG-FG-LO-IM-LG-AY-CM-CF-IM-EN-PS-RS-ST-BOOKS_STRING-ENEMY_STRING"
